...
var __AAC_ASSET_BASE = (typeof document !== 'undefined' && document.currentScript && document.currentScript.src) ? new URL('.', document.currentScript.src).href : '';
Module['locateFile'] = function(filename) {
    return ENVIRONMENT_IS_NODE ? __dirname+'/'+filename : __AAC_ASSET_BASE+filename;
}
